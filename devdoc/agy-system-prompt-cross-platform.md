...
이 문서의 프로세스 I/O 설명은 2026-07-13 당시 구현 기준이다. 2026-09-05에
구조화 응답 검증, 전체 요청 시간 제한, 예약 세션 복제가 보완됐다. 현재
전송 구현과 재검증 결과는 [AGY 1.1.27 검증 기록](agy-1.1.27-verification.md#후속-수정과-재검증)과
[사용 문서](../docs/how-to-use-agy-antigravity.md)를 참고한다.
