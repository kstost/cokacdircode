...
/companion_ping off`} />
      ...
      <SubSection title="/effort">
        ...
        <P>{t(
          ...
          <>목록의 모든 모델에서 <IC>xhigh</IC>는 extra-high reasoning을 적용합니다. <IC>max</IC>는 Astra, Sol, Terra, Luna에서 사용할 수 있고, <IC>ultra</IC>는 Astra, Sol, Terra에서 automatic task delegation을 추가로 활성화합니다.</>
        )}</P>
        <P>{t(
